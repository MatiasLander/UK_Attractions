...
Certain tourist attractions do not have a number of tourists visited in that year available, thus when calculating the mean/median, this leads to NA as the final result, as mean/median cannot be calculated with NA values
...
There are a lot of large data set values which push the mean further past the median
